<div class="dr-modal dr-modal-xl dr-modal__default dr-modal_new is-active" id="modal-available-count">

    <div class="dr-modal-wrapper">
        <div class="dr-modal__content bg-light">
            <div class="dr-modal__header">
                <div class="dr-modal__title">
                    <p class="dr-h3 ff-secondary">Наличие товара в магазинах</p>
                </div>
            ...
            <div class="dr-modal__body">
                <div class="dr-modal__body-content">
                    ...
                    <div class="dr-operation-controls dr-operation-controls_flex">
                        <div class="dr-operation-controls__item">
                            <ul class="nav nav-tabs dr-nav-tabs">
                                <li ><a data-toggle="tab" href="#map-point">Карта</a></li>
                                <li class="active"><a data-toggle="tab" href="#list-point">Список</a></li>
                            </ul>
                        </div>
                        <div class="dr-operation-controls__item">
                    ...
                    <div class="dr-tab-content tab-content">
                        <div id="map-point" class="tab-pane ">
                        ...
                        <div id="list-point" class="tab-pane active">
                                    ...
                                    <div class="point-shop__item">
                                        ...
                                        <div class="point-shop__item-footer">
                                            <div class="dr-form-group__flex">
                                                ...
                                                <button class="dr-btn dr-btn__small dr-btn-inline dr-btn-brown__light">Показать на карте</button>
                                            </div>
                                        </div>
                                    </div>
                                <?php endfor; ?>
